...
: ${AMENT_CURRENT_PREFIX:="/home/toffanetto/ecai21/src/install/two_turtle_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/two_turtle_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/two_turtle_control/environment/path.sh"
